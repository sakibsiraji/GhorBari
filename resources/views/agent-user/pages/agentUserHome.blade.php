@extends('agent-user.layouts.layout')
@section('content')
<!-- start: page -->
<div class="row">
          ...
          <header class="card-header bg-primary w-100">
            ...
            <div class="widget-profile-info">
              <div class="profile-picture">
                <img src="{{asset('Backend/img/!logged-user.jpg')}}">
              </div>
              ...
              <li>
                <div class="tm-box">
                  ...
                  <div class="thumbnail-gallery">
                    <a class="img-thumbnail lightbox" href="{{asset('Backend/img/projects/project-4.jpg')}}" data-plugin-options='{ "type":"image" }'>
                      <img class="img-fluid" width="215" src="{{asset('Backend/img/projects/project-4.jpg')}}">
                      <span class="zoom">
