<head>
  ...
  <title>Login | GhorBari.xyz</title>
  ...
  <!-- Demo CSS -->
  <link rel="stylesheet" href="{{asset('Frontend/css/demos/demo-real-estate.css')}}">

  <!-- Skin CSS -->
  <link id="skinCSS" rel="stylesheet" href="{{asset('Frontend/css/skins/skin-real-estate.css')}}">
